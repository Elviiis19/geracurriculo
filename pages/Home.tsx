...
const Home: React.FC = () => {
  ...
  const MiniVitae = () => (
    <div className="w-full h-full bg-white p-4 flex flex-col items-center border-b border-slate-200 pointer-events-none select-none overflow-hidden">
        <div className="w-3/4 h-2 bg-slate-900 mb-1"></div> {/* Name */}
        <div className="w-1/2 h-1 bg-slate-400 mb-2"></div> {/* Title */}
        <div className="w-full h-px bg-slate-200 mb-2"></div>
        <div className="w-full space-y-2">
            <div className="w-1/3 h-1 bg-slate-300 mx-auto mb-1"></div> {/* Section Title */}
            <div className="w-full h-12 bg-slate-50 border border-slate-100 rounded p-1">
             ...
             <div className="w-1/3 h-1 bg-slate-300 mx-auto mb-1 mt-2"></div> {/* Section Title */}
  ...
  const MiniMinimal = () => (
    <div className="w-full h-full bg-white p-5 flex flex-col border-b border-slate-200 pointer-events-none select-none overflow-hidden">
        <div className="w-2/3 h-3 bg-slate-800 mb-1"></div> {/* Name Left */}
  ...
  const MiniModern = () => (
    <div className="w-full h-full bg-white flex border-b border-slate-200 pointer-events-none select-none overflow-hidden">
        {/* Sidebar */}
  ...
  const MiniCreative = () => (
    <div className="w-full h-full bg-white flex flex-col border-b border-slate-200 pointer-events-none select-none overflow-hidden">
        {/* Header */}
  ...
  const MiniTech = () => (
    <div className="w-full h-full bg-white flex flex-col border-b border-slate-200 pointer-events-none select-none overflow-hidden font-mono">
         {/* Tech Header */}
  ...
  const TemplateCard = ({ title, description, tags, templateParam, VisualComponent }: any) => (
      <Link 
        to={`/builder?template=${templateParam}`} 
  ...
  const FAQItem = ({ question, answer }: { question: string, answer: string }) => (
    <details className="group bg-white rounded-xl border border-slate-200 overflow-hidden">
      <summary className="flex items-center justify-between p-5 cursor-pointer font-bold text-slate-800 hover:bg-slate-50 transition-colors">
        {question}
  ...
  return (
    <Layout>
      ...
      <div className="bg-white pt-20 pb-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-5">
            <Link to="/builder" className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-bold rounded-2xl text-white bg-slate-900 hover:bg-black shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
              <Zap size={20} className="mr-2 text-yellow-400" /> Fazer Meu Currículo
            </Link>
            <a href="#modelos" className="inline-flex items-center justify-center px-8 py-4 border-2 border-slate-200 text-lg font-bold rounded-2xl text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 shadow-sm transition-all duration-300">
      ...
      <div className="bg-slate-900 py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <Link to="/builder" className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-xl px-12 py-5 rounded-2xl shadow-2xl hover:shadow-blue-500/20 hover:scale-105 transition-all duration-300">
